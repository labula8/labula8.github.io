...
docker run -d --name="codis-yu2" -h "codis" -p 28087:28087 -p 21000:21000 -p 29000:29000 codis-yu

docker run -d --name="codis-yu3" -h "codis" -p 38087:38087 -p 31000:31000 -p 39000:39000 codis-yu

docker container stop  f017de8744d49e73696ea29a5f955b7a3b0b41270225b64fef81582f22f97a23
...
rmr /zk/codis/db_test/fence
rmr /zk/codis/db_test/slots
rmr /zk/codis/db_test/servers
rmr /zk/codis/db_test/proxy
rmr /zk/codis/db_test/migrate_tasks
rmr /zk/codis/db_test/dashboard
rmr /zk/codis/db_test/LOCK
rmr /zk/codis/db_test/actions
rmr /zk/codis/db_test/ActionResponse
...
/opt/codis/zookeeper/bin/zkServer.sh start &
...
/opt/codis/bin/codis-config -c /opt/codis/conf/config.ini dashboard &

/opt/codis/bin/codis-config -c /opt/codis/conf/config.ini slot init &

./codis-config -c /opt/codis/conf/config.ini -L /opt/codis/logs/add_group.log server add 1 localhost:6380 m
./codis-config -c /opt/codis/conf/config.ini -L /opt/codis/logs/add_group.log server add 2 localhost:6381 s

./codis-config -c /opt/codis/conf/config.ini -L /opt/codis/logs/dashboard.log dashboard --addr 0.0.0.0:1808

/opt/codis/bin/codis-config -c /opt/codis/conf/config.ini -L /opt/codis/logs/add_group.log server add 1 localhost:6380 m &
/opt/codis/bin/codis-config -c /opt/codis/conf/config.ini -L /opt/codis/logs/add_group.log server add 2 localhost:6381 s &
/opt/codis/bin/codis-config -c /opt/codis/conf/config.ini -L /opt/codis/logs/dashboard.log dashboard --addr 0.0.0.0:1808 &
...
docker runt -it ubuntu-test -p 8080:8080
